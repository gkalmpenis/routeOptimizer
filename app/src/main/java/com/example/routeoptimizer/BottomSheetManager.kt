...
class BottomSheetManager {
    ...
    private val ADD_AS_STOP: String = R.string.add_stop_txt.toString()
    private val REMOVE_FROM_STOPS: String = R.string.remove_stop_txt.toString()
...
//    protected fun setOptimizeButtonReference(optimizeButton: Button?) { this.optimizeButton = optimizeButton }
    ...
    fun changeStateOfStopsButton(state: StopsButtonState) {
...
//    fun addStopsButtonOnClickListener() {
//        binding.btnStops.setOnClickListener { v ->
